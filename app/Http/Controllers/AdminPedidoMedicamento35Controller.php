	...
	class AdminPedidoMedicamento35Controller extends \crocodicstudio\crudbooster\controllers\CBController
    {
        ...
        public function __construct(Request $request)
        {
            ...
            foreach ($this->articulos as $articulo) {
                $articulo_ids[] = $articulo->id_articulo;
            }

            $this->medicamento = DB::table('articulosZafiro')->whereIn('id_articulo', $articulo_ids)->get();
        ...
        public function cbInit()
        {
			...
			$columns = [];
			$columns[] = ['label'=> 'Medicamentos solicitados',
            ...
            */
            ...
            //$this->addaction[] = ['label'=>'AUDITAR : SOLICITUD APROBADA','url'=>CRUDBooster::mainpath('set-status/8/[id]'),'icon'=>'fa fa-check','color'=>'success','showIf'=>"[estado_solicitud_id] == 1 && ($PRIVILEGIO == 40 || $PRIVILEGIO == 38 ||  $PRIVILEGIO == 41)", 'confirmation'=>true];
            //$this->addaction[] = ['label'=>'AUDITAR : SOLICITUD RECHAZADA','url'=>CRUDBooster::mainpath('set-status/9/[id]'),'icon'=>'fa fa-times','color'=>'danger','showIf'=>"[estado_solicitud_id] == 1 &&  ($PRIVILEGIO == 40 || $PRIVILEGIO == 38 ||  $PRIVILEGIO == 41)", 'confirmation'=>true];
            $this->addaction[] = ['label' => 'Anular solicitud', 'url' => CRUDBooster::mainpath('set-status/5/[id]'), 'icon' => 'fa fa-check', 'color' => 'danger', 'showIf' => "[estado_solicitud_id] == 1 &&  ($PRIVILEGIO == 40 || $PRIVILEGIO == 38 ||  $PRIVILEGIO == 41)", 'confirmation' => true];
            ...
            */
            ...
            function addRow() {
    var medicamentos = ".$this->medicamento.";

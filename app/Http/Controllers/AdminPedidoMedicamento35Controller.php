<?php namespace App\Http\Controllers;
	...
	class AdminPedidoMedicamento35Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nombre y Apellido Afiliado','name'=>'afiliados_id','type'=>'datamodal','validation'=>'required|integer|min:0','width'=>'col-sm-10','datamodal_table'=>'afiliados','datamodal_columns'=>'apeynombres,documento,sexo,localidad','datamodal_select_to'=>'nroAfiliado:nroAfiliado,obra_social:obra_social','datamodal_size'=>'large'];
			...
			$this->form[] = ['label'=>'Obra social', 'name'=>'obra_social', 'type'=>'text', 'validation'=>'required|min:1|max:255', 'width'=>'col-sm-10', 'readonly'=>true];
			...
			$this->form[] = ['label'=>'Receta Post-datada','name'=>'postdatada','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'postdatada,cantidad'];
			...
			$columns = [];
			$columns[] = ['label'=> 'Medicamentos solicitados', 'name'=>'articuloZafiro_id', 'type'=>'datamodal', 'datamodal_table'=>'articulosZafiro', 'validation'=>'required','datamodal_columns_alias'=>'Descripción del artículo, Presentación, Monodroga, ID ARTÍCULO','datamodal_columns'=>'des_articulo,presentacion,des_monodroga,id_articulo','datamodal_size'=>'large', 'datamodal_where'=>'id_familia = "01"', 'AND', 'id_familia= "14"', 'datamodal_select_to'=>'presentacion:presentacion','required'=>true];

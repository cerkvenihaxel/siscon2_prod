<?php namespace App\Http\Controllers;
	...
	class AdminPedidoMedicamento1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Ant Est Sol","name"=>"ant_est_sol"];
			$this->col[] = ["label"=>"Ant Postdatada","name"=>"ant_postdatada"];
			...
			$this->form[] = ['label'=>'Ant Est Sol','name'=>'ant_est_sol','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Ant Postdatada','name'=>'ant_postdatada','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Diagnostico','name'=>'diagnostico','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:pedido_medicamento','width'=>'col-sm-10','placeholder'=>'Introduce una dirección de correo electrónico válida'];
			...
			$this->form[] = ['label'=>'Obra Social','name'=>'obra_social','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Observaciones','name'=>'observaciones','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Patologia','name'=>'patologia','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Renovaciones','name'=>'renovaciones','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];

<?php namespace App\Http\Controllers;
	...
	class AdminMedicosAposController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "medicos_apos";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Matricula","name"=>"matricula"];
			$this->col[] = ["label"=>"Nombre medico","name"=>"nombremedico"];
			$this->col[] = ["label"=>"Especialidad","name"=>"especialidad"];
			$this->col[] = ["label"=>"Tipo","name"=>"tipo"];
			$this->col[] = ["label"=>"Centro Facturador","name"=>"centro_facturador"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nombre medico','name'=>'nombremedico','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Centro Facturador','name'=>'centro_facturador','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Centro Facturador","name"=>"centro_facturador","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

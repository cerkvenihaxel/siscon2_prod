...
class EscritorioConvenioMedicamentosController extends Controller
{
    public function deskView(){
        ...
        return view('escritorioConvenioMedicamentosView', compact('nroEntrantes', 'nroAutorizados', 'nroRechazados', 'nroAsignados', 'nroAuditados','nroProcesados', 'nroRechazadosGlobal','nroEntregados', 'patologiasName'));
    }

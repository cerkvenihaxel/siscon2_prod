<?php namespace App\Http\Controllers;
	...
	class AdminAnulacionesController extends \crocodicstudio\crudbooster\controllers\CBController {
...
*/
			...
			$this->form[] = ['label'=>'Estado Solicitud','name'=>'estado_solicitud_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'estado_solicitud,estado','value'=>5, 'readonly'=>true];
			...
			$this->form[] = ['label'=>'Nombre proveedor anulado','name'=>'autorizado','type'=>'text','validation'=>'required|required','width'=>'col-sm-10'];
...
*/
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        //Your code here
		DB::table('cotizaciones')->where('nrosolicitud',$postdata['nrosolicitud'])->update(['estado_solicitud_id'=>5]);
		DB::table('entrantes')->where('nrosolicitud',$postdata['nrosolicitud'])->update(['estado_solicitud_id'=>5]);
		DB::table('adjudicaciones')->where('nrosolicitud',$postdata['nrosolicitud'])->update(['estado_solicitud_id'=>5]);
	    }

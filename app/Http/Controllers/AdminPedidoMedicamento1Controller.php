...
//				if ($privilegio == 1 || $privilegio == 38 || $privilegio == 39){
			...
			$columns = [];
			$columns[] = ['label'=>'Medicamento','name'=>'articuloZafiro_id','type'=>'datamodal','validation'=>'required|integer|min:0','width'=>'col-sm-10','datamodal_table'=>'articulosZafiro','datamodal_columns'=>'presentacion_completa','datamodal_size'=>'large'];

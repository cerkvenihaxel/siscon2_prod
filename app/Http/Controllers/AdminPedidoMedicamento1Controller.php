...
//				if ($privilegio == 1 || $privilegio == 38 || $privilegio == 39){
			...
			//$this->form[] = ['label'=>'Elegir zona de retiro','name'=>'zona_residencia','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10', 'dataenum' => 'Norte;Sur;Este;Oeste;FARMAPOS;Centro;Chamical;Chilecito;Famatina;Villa Unión;Incluir Salud San Juan;Farmapos Ministerio;Zona A;Zona B;Zona C; Zona D'];
			$this->form[] = [
				'label' => 'Elegir zona de retiro',

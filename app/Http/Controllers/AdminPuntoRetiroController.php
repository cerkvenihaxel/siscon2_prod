<?php namespace App\Http\Controllers;
	...
	class AdminPuntoRetiroController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->col[] = ["label"=>"Proveedor","name"=>"proveedor_convenio_id","join"=>"proveedores_convenio,nombre"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
            $this->form[] = ['label'=>'Proveedor','name'=>'proveedor_convenio_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'proveedores_convenio,nombre'];

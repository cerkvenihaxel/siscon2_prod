<?php namespace App\Http\Controllers;
	...
	class AdminConvenioOficinaOs1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->form[] = ['label'=>'Email','name'=>'email','type'=>'text','validation'=>'min:1|max:255|email|','width'=>'col-sm-10','placeholder'=>'Introduce una dirección de correo electrónico válida', 'value'=>DB::table('pedido_medicamento')->where('id',$url)->value('email')];

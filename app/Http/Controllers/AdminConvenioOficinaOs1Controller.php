<?php namespace App\Http\Controllers;
	...
	class AdminConvenioOficinaOs1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->form[] = ['label'=>'Estado Solicitud','name'=>'estado_solicitud_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','required'=>true,'datatable'=>'estado_solicitud,estado','value'=>2];
            ...
            $this->form[] = ['label'=>'Patologías','name'=>'patologia','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10', 'dataenum'=>'Artritis; Diabetes; Fibrosis; Fibrosis Pulmonar; Fibrosis Quística; HIV; Hemodiálisis; Hipertensión; Oncología; Otras patologías; Esclerosis; Transplantados; Internación Domiciliaria.','required'=>true, 'value'=>DB::table('pedido_medicamento')->where('id',$url)->value('patologia')];

<?php namespace App\Http\Controllers;
	...
	class AdminCotizacionConvenio1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Custom Field","name"=>"custom_field"];
			$this->col[] = ["label"=>"Direccion Retiro","name"=>"direccion_retiro"];
			...
			$this->form[] = ['label'=>'Direccion Retiro','name'=>'direccion_retiro','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Pedido','name'=>'id_pedido','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'pedido,id'];
			$this->form[] = ['label'=>'Localidad Retiro','name'=>'localidad_retiro','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Nro Factura','name'=>'nro_factura','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nro Remito','name'=>'nro_remito','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Tel Retiro','name'=>'tel_retiro','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Zona Residencia','name'=>'zona_residencia','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Zona Retiro','name'=>'zona_retiro','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];

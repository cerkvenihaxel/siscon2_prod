...
<section class="box">
    <div class="container-fostrap">
        <div>
            <h1 class="heading">
                Asistencia Virtual para médicos
            </h1>
        </div>
        <div class="content">
            <div class="container-sm">
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <div class="card">
                            <a class="img-card" href="/pdf/medicoAsist.pdf">
                            <img src="/pdflogo.png" />
                          </a>
                            ...
                            <div class="card-read-more">
                                <a href="/pdf/medicoAsist.pdf" target="_blank" class="btn btn-link btn-block">
                                    Ir al instructivo
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="card">
                            <a class="img-card" href="https://www.youtube.com/watch?v=KS6qhrjlvsw">
                            <img src="/youtube.png" />
                          </a>
                            <div class="card-content">
                                <h4 class="card-title">
                            ...
                            <div class="card-read-more">
                                <a href="https://www.youtube.com/watch?v=KS6qhrjlvsw" target="_blank" class="btn btn-link btn-block">
